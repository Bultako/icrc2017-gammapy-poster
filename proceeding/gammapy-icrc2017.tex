...
Figure~\ref{fig:stack}). Initially the focus was to implement the “classical TeV
analysis”, using 2- dimensional sky images for detection and morphology
...
gamma-ray emission, as well as background is in development. Further
