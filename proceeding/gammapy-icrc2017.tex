...
In this paper we focus on the software and technical aspects of Gammapy. We
...
and a code example and explanation of how Gammapy works and how it can be used
in Section~\ref{sec:code}. Finally, Section~\ref{sec:dev} describes aspects of
the Gammapy project like code development, testing and review as well as package
distribution and support for users, and Section~\ref{sec:conclusions} presents
our conclusions concerning Gammapy as as CTA science tool prototype.
